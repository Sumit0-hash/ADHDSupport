...
export const api = {
  ...
  courses: {
    ...
    getPaymentLink: (courseId: string) =>
      apiClient.get<{ paymentLink: string }>(`/courses/${courseId}/payment-link`),
    getCourseLink: (courseId: string) =>
      apiClient.get<{ courseLink: string }>(`/courses/${courseId}/course-link`),
  ...
  events: {
    ...
    getPaymentLink: (eventId: string) =>
      apiClient.get<{ paymentLink: string }>(`/events/${eventId}/payment-link`),
    getEventLink: (eventId: string) =>
      apiClient.get<{ eventLink: string }>(`/events/${eventId}/event-link`),
