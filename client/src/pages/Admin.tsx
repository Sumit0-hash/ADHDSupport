    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            if (deleteTarget.type === 'course') {
                ...
                setCourses(courses.filter(c => c._id !== deleteTarget.id));
                ...
                setResources(resources.filter(r => r._id !== deleteTarget.id));
            }
            setDeleteTarget(null);
        } catch (e) {
            console.error(`Failed to delete ${deleteTarget.type}:`, e);
